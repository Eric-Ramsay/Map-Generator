...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building("Water Net", 4, 2, 0, 2, 0));
	buildings.push_back(UI_Building("Mill", 10, 5, 5, 3, 1));
...
enum RES {
	WORKERS, W_WELLBEING, SPECIALISTS, S_WELLBEING, G_JOBS, W_JOBS, S_JOBS, POWER, WOOD, STONE, GOLD, FOOD, WATER
};
...
struct Player {
	...
	float res[WATER+1] = {25, 50, 0, 50, 0, 0, 0, 50, 5, 5, 15, 1000, 1000};
	float income[WATER+1] = {25, 50, 0, 50, 0, 0, 0, 50, 5, 5, 15, 1000, 1000};
	float max[WATER+1] = {50, 100, 0, 100, -1, -1, -1, 100, 25, 25, 500, 1000, 1000};
