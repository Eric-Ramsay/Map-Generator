...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building("Well", 8, 12, 0, 1, 0));
	buildings.push_back(UI_Building("Mine", 15, 5, 15, 8, 1));
	buildings.push_back(UI_Building("Storehouse", 5, 15, 10, 4, 2));
	buildings.push_back(UI_Building("Administrative Office", 10, 5, 20, 0, 4));
...
struct Player {
	...
	float res[WATER+1] = {250, 25, 0, 0, 0, 0, 50, 500, 500, 1500, 1000, 1000};
	float max[WATER+1] = {250, 50, 0, -1, -1, -1, 100, 2500, 2500, -1, 1000, 1000};
