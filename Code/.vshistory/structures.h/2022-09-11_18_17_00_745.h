...
struct UI_Building {
	...
	int costs[3] = {0, 0, 0, 0, 0};
	short time = 0;

	short anim_num = 1;
	short anim_speed = 1; //lower means faster
	UI_Building(std::string n = "", short w = 0, short s = 0, short g = 0, , short work, short spec = 0, short aN = 1, short aS = 1) {
		name = n;
		time = 5;
		anim_num = aN;
		anim_speed = aS;
...
enum BUILDINGS {
	HOUSE, FARM, WATER_NET, MILL, LUMBER_CAMP, WELL, MINE, STOREHOUSE
};
...
std::vector<UI_Building> initBuildings() {
	...
	//------------------------------------WOOD STONE GOLD
	buildings.push_back(UI_Building("House", 3, 0, 5));
	buildings.push_back(UI_Building("Farm", 3, 0, 0));
	buildings.push_back(UI_Building("Water Net", 2, 1, 0));
	buildings.push_back(UI_Building("Mill", 10, 5, 0));
	buildings.push_back(UI_Building("Lumber Camp", 15, 0, 0));
	buildings.push_back(UI_Building("Well", 5, 5, 0));
	buildings.push_back(UI_Building("Mine", 10, 10, 10));
	buildings.push_back(UI_Building("Storehouse", 5, 15, 10));
...
enum RES {
	WELLBEING, WOOD, STONE, GOLD, WORKERS, G_JOBS, W_JOBS, SPECIALISTS, S_JOBS, FOOD, WATER, LUXURIES, COPPER, TIN, BRONZE, IRON, CATTLE, HORSES
};
...
struct Player {
	...
	float res[HORSES+1] = {50, 5, 5, 5, 25, 0, 0, 0, 0, 1000, 1000, 0, 0, 0, 0, 0, 0, 0};
	float max[HORSES+1] = {100, 25, 25, -1, 50, -1, -1, 0, -1, 1000, 1000, 50, 50, 50, 50, 50, 10, 10};
