...
struct eBUILDING {
	enum BUILDING {
		BNONE, ROAD, HOUSE, FARM, WATER_NET, MILL, LUMBER_CAMP, WELL, MINE, STOREHOUSE, ADMIN_OFFICE, WOOD_SHOP
	};
};
...
struct Tile {
	...
	ELEVATION elev = FLAT;
	eFOREST::FOREST forest = NONE;

	eBUILDING::BUILDING building = NONE;
};
