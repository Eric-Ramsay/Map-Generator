...
enum BUILDINGS {
	HOUSE, FARM, WATER_NET, MILL, LUMBER_CAMP, WELL, MINE, STOREHOUSE, ADMIN_OFFICE, WOOD_SHOP
};
...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building("Farm", 6, 0, 0, 3, 0));
	buildings.push_back(UI_Building("Water Net", 4, 2, 0, 3, 0));
	buildings.push_back(UI_Building("Mill", 10, 5, 5, 3, 0));
	buildings.push_back(UI_Building("Lumber Camp", 15, 0, 0, 6, 0));
	buildings.push_back(UI_Building("Well", 4, 12, 0, 1, 0));
	buildings.push_back(UI_Building("Mine", 15, 5, 15, 8, 1));
	buildings.push_back(UI_Building("Storehouse", 5, 15, 10, 4, 1));
	buildings.push_back(UI_Building("Administrative Office", 10, 5, 20, 0, 2));
	buildings.push_back(UI_Building("Wood Workshop", 15, 10, 15, 0, 3));
...
enum RES {
	POWER, WORKERS, SPECIALISTS, G_JOBS, W_JOBS, S_JOBS, WELLBEING, WOOD, STONE, GOLD, FOOD, WATER
};
...
struct Player {
	...
	float res[WATER+1] = {250, 25, 0, 0, 0, 0, 50, 5, 5, 15, 1000, 1000};
	float max[WATER+1] = {250, 50, 0, -1, -1, -1, 100, 25, 25, -1, 1000, 1000};
