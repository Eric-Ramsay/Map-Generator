...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building("Water Net", 5, 3, 0, 5, 0, 0));
	...
	buildings.push_back(UI_Building("Storehouse", 5, 3, 0, 5, 0, 0));
	buildings.push_back(UI_Building("Well", 5, 3, 0, 5, 0, 0));
