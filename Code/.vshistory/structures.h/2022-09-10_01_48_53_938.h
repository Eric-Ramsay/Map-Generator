...
struct UI_Building {
	...
	UI_Building(std::string n = "", short t = 5, short work = 0, short spec = 0, short w = 0, short s = 0, short g = 0, short aN = 1, short aS = 1) {
		name = n;
		time = t;
		anim_num = aN;
		anim_speed = aS;
...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building("Mill", 5, 3, 0, 5, 0, 0));
...
enum RES {
	WOOD, STONE, GOLD, WORKERS, SPECIALISTS, W_JOBS, S_JOBS, FOOD, WATER, LUXURIES, COPPER, TIN, BRONZE, IRON, CATTLE, HORSES
};
...
struct Player {
	...
	std::vector<float> resources = {5, 5, 5, 25, 0, 500, 500, 0, 0, 0, 0, 0, 0, 0, 0, 0};
	std::vector<float> max = {25, 25, -1, 50, 0, 1000, 1000, 50, 50, 50, 50, 50, 10, 10, -1, -1};
