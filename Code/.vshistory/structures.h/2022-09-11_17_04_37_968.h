...
std::vector<UI_Building> initBuildings() {
	...
	buildings.push_back(UI_Building("Storehouse", 5, 10, 10));
...
enum RES {
	WELLBEING, WOOD, STONE, GOLD, WORKERS, W_JOBS, SPECIALISTS, S_JOBS, FOOD, WATER, LUXURIES, COPPER, TIN, BRONZE, IRON, CATTLE, HORSES
};
