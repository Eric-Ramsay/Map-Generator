...
enum RES {
	INFLUENCE, WOOD, STONE, GOLD, WORKERS, SPECIALISTS, FOOD, POTABLE, LUXURIES, COPPER, TIN, BRONZE, IRON, CATTLE, HORSES
};
...
struct Player {
	...
	std::vector<short> resources = {100, 5, 5, 5, 25, 0, 500, 500, 0, 0, 0, 0, 0, 0, 0};
	std::vector<short> max = {100, 25, 25, 100, 50, 0, 1000, 1000, 50, 50, 50, 50, 50, 10, 10};
