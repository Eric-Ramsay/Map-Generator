...
enum FOREST {
	FPLACEHOLDER, TEMPERATE, JUNGLE, TAIGA, GLADE, SHRUB, FORAGE
};

enum BUILDING {
	BPLACEHOLDER, ROAD, HOUSE, FARM, WATER_NET, MILL, LUMBER_CAMP, WELL, MINE, STOREHOUSE, ADMIN_OFFICE, WOOD_SHOP
};
