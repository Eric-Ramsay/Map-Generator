...
void Income(Player& p) {
	...
	float m[HORSES + 1] = { 25, 25, -1, 50, -1, 0, -1, 1000, 1000, 50, 50, 50, 50, 50, 10, 10, };
	...
	income[FOOD] -= (p.resources[WORKERS] + p.resources[SPECIALISTS]) * 3;
	income[WATER] -= (p.resources[WORKERS] + p.resources[SPECIALISTS]) * 3;
