...
std::vector<std::vector<Tile>> createMap(std::vector<std::vector<MapTile>> m = {}) {
	...
	hill(map, 200, (int)round(20.0 * MODI), 60);
	hill(map, 100, (int)round(150.0 * MODI), 60);
	hill(map, 60, (int)round(150.0 * MODI), 60);
	hill(map, 35, (int)round(150.0 * MODI), 60);
	hill(map, 20, (int)round(150.0 * MODI), 60);
