...
void DrawResources() {
	...
	for (int i = 0; i < 2; i++) {
		...
		Print(shade + add + trimNum(p.income[WORKERS + i]) + shade, dX + 26.5 * scale, dY + 17.5 * scale, scale);
	...
	for (int i = 0; i < 4; i++) {
		...
		Print(shade + add + trimNum(p.income[POWER + i]) + shade, dX + 26.5 * scale, dY + 17.5 * scale, scale);
	...
	for (int i = 0; i < 2; i++) {
		...
		Print(shade + add + trimNum(p.income[FOOD + i]) + shade, dX + 26.5 * scale, dY + 17.5 * scale, scale);
