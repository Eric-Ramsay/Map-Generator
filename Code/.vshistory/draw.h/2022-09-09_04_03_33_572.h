...
void DrawUI() {
	...
	Print("Wood: " + to_str(buildings[selected].costs[2]), rX + rW / 4, rY + rH - 190, 2, true);
	Print("Stone: " + to_str(buildings[selected].costs[3]), rX + rW / 4, rY + rH - 120, 2, true);
	Print("Gold: " + to_str(buildings[selected].costs[4]), rX + 3 * rW / 4, rY + rH - 190, 2, true);
	Print("Time: " + to_str(buildings[selected].time), rX + 3 * rW / 4, rY + rH - 120, 2, true);
