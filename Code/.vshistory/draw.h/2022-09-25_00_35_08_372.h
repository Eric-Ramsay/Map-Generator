...
void drawSprite(int sX, int sY, int UI.W, int UI.H, float dX, float dY, int scale = 1, sf::Color color = sf::Color(255, 255, 255), bool windraw = false) {
...
void drawSprite(int sX, int sY, int UI.W, int UI.H, float dX, float dY, float x_scale, float y_scale, sf::Color color = sf::Color(255, 255, 255), bool windraw = false) {
	static bool init = false;
	static sf::Texture sprites;
	if (!init) {
		sprites = createTexture("./Sprites/sprites.png");
