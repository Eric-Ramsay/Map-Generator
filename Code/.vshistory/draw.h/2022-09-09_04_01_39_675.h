...
void DrawUI() {
	...
	Print("Stone: " + buildings[selected].costs[3], rX + rW / 4, rY + rH - 100, 2, true);
	Print("Gold: " + buildings[selected].costs[4], rX + 3 * rW / 4, rY + rH - 200, 2, true);
	Print("Time: " + buildings[selected].time, rX + 3 * rW / 4, rY + rH - 100, 2, true);
