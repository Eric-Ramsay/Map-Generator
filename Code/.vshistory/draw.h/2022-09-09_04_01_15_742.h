...
void DrawUI() {
	...
	Print("Wood: " + buildings[selected].costs[2], rX + rW / 4, rY + rH - 200, 2, true);
	Print("Stone: " + buildings[selected].costs[2], rX + rW / 4, rY + rH - 100, 2, true);
	Print("Gold: " + buildings[selected].costs[2], rX + 3 * rW / 4, rY + rH - 200, 2, true);
	Print("Time: " + buildings[selected].costs[2], rX + 3 * rW / 4, rY + rH - 100, 2, true);
