...
void DrawUI() {
	...
	Print("Wood: *BROWN*" + to_str(buildings[selected].costs[2]) + "*BROWN*", rX + rW / 4, rY + rH - 190, 2, true);
	Print("Stone: *GREY*" + to_str(buildings[selected].costs[3]) + "*GREY*", rX + rW / 4, rY + rH - 120, 2, true);
	Print("Gold: *GOLD*" + to_str(buildings[selected].costs[4]) + "*GOLD*", rX + 3 * rW / 4, rY + rH - 190, 2, true);
	Print("Time: *GREEN*" + to_str(buildings[selected].time)+"*GREEN*", rX + 3 * rW / 4, rY + rH - 120, 2, true);
