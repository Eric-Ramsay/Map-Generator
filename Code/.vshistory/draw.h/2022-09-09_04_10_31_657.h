...
void DrawUI() {
	...
	Print("*BROWN*Wood: " + to_str(buildings[selected].costs[2]) + "*BROWN*", rX + rW / 4, rY + rH - 190, 2, true);
	Print("*GREY*Stone: " + to_str(buildings[selected].costs[3]) + "*GREY*", rX + rW / 4, rY + rH - 120, 2, true);
	Print("*GOLD*Gold: " + to_str(buildings[selected].costs[4]) + "*GOLD*", rX + 3 * rW / 4, rY + rH - 190, 2, true);
	Print("*GREEN*Time: " + to_str(buildings[selected].time)+"*GREEN*", rX + 3 * rW / 4, rY + rH - 120, 2, true);
