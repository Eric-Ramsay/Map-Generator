...
void DrawUI() {
	...
	Print("*BROWN*Wood: *BROWN*" + to_str(buildings[selected].costs[0]), rX + rW / 4, rY + rH - 260, 2, true);
	Print("*GREY*Stone: *GREY*" + to_str(buildings[selected].costs[1]), rX + rW / 4, rY + rH - 260, 2, true);
