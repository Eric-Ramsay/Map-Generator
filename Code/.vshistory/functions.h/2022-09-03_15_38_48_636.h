...
Tile Terrain_Convert(MapTile t) {
	...
	case 'g': til.type = GRASS_1; break;
	case 'p': til.type = GRASS_2; break;
	case 'v': til.type = GRASS_3; break;
	case 'q': til.type = GRASS_4; break;
	case 'o': til.type = GRASS_5; break;
	case 'd': til.type = DESERT; break;
	case 't': til.type = BARREN; break;
